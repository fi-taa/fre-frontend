...
import { useGetCurrentUserQuery, useCreateManagerMutation } from '@/store/slices/usersApi';
...
export default function AddManagerPage() {
  ...
  const allowedDepartmentIds = currentUser?.role === 'super_admin' ? undefined : currentUser?.department_ids;
    ...
    <div className="min-h-screen bg-bg-beige flex flex-col relative">
      ...
      <div className="flex-1 overflow-auto relative z-10">
        <div className="max-w-lg mx-auto p-6 space-y-6">
          ...
          <h1 className="text-xl font-bold text-text-primary">Add Manager</h1>
